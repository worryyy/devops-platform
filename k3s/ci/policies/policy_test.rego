...
valid_deployment := {"kind": "Deployment", "metadata": {"name": "valid"}, "spec": {"template": {"spec": {"containers": [{
  "name": "app",
  "image": "ccr.ccs.tencentyun.com/k3s-platform/app:git-abc12345@sha256:1111111111111111111111111111111111111111111111111111111111111111",
...
test_git_tag_without_digest_denied if {
  git_tag := object.union(container, {"image": "ccr.ccs.tencentyun.com/k3s-platform/app:git-abc12345"})
...
test_dev_tag_allowed if {
  dev := object.union(container, {"image": "ccr.ccs.tencentyun.com/k3s-platform/app:dev"})
